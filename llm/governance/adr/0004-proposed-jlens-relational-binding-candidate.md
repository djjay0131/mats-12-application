...
| 3 | Comparison against the accepted candidate using the selection rubric | **Done.** `llm/plans/project-candidates.md` — both score 24/25; tie broken on preparation and failure-mode asymmetry. |
