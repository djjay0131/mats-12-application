...
Mission: execute the bounded J-Lens design-verification sprint defined in llm/construction/jlens-design-verification-sprint.md. This is not the main experiment. Your job is to determine GO, REVISE, or NO-GO without expanding scope or manufacturing a positive result.
...
Execute only Setup and V1 from llm/construction/jlens-design-verification-sprint.md. Do not perform V2 or V3.
...
PASS or FAIL must follow the exact gate in llm/construction/jlens-design-verification-sprint.md. Do not soften a failed requirement into “promising.”
...
Execute only V2 from llm/construction/jlens-design-verification-sprint.md.
...
Execute only V3 from llm/construction/jlens-design-verification-sprint.md.
...
Update llm/application/verification-ledger.md only with checks Jason explicitly confirms. Otherwise create results/design-verification/human-verification-pending.md.
```
