...
| `stage3-controls` | Experiment 2 controls on frozen held-out data (n=160). Shuffling the answer key drops J-Lens to chance; replacing the trained matrix with a random one drops both the direction score to chance and the median rank of the correct city from about a hundred to over a hundred thousand. | CL-02, CL-04 | 160 | 20260827 | `a3cf394362b5` | 1b3da50 | 2026-09-05 | job 554591; label-permutation control and norm-matched random transport |
| `phase1-step1-heldout2` | Fresh held-out draw (seed 20260917, 60 pairs) scored once at the frozen settings, beside the application's draw and the pool. Left: J-Lens direction frac vs label-permutation control. Right: lens accuracy on records where the model's own next-token preference is wrong. | phase1-step1 | 160 / 240 / 400 | 20260917 (new draw); 20260827 (original, pool) | `4027b3cba0c8` | fe1ca16 | 2026-09-17 | R1 gap(new, relcomp)=0.2375; R2 combined acc(model-wrong, relcomp)=0.2581 n=93; agent-unverified |
| `phase1-step2-fact-tokens` | Fact-token probes on the combined held-out (n=400 records, 800 fact tokens): arm 3 (diff-in-means, dev-fit), J-Lens and logit lens at every block; dotted = label-permutation control; vertical line = frozen L30. | phase1-step2 | 400 records / 800 tokens | 20260827 (control derangement) | `50b2fe0bafc1` | 7c55733 | 2026-09-17 | agent-unverified; layer curves reported, not selected on |
| `phase1-step5-lr-probe` | Trained logistic-regression probe vs difference-in-means, leave-one-pair-out on the combined held-out (n=400 records), every block; dotted = label-permutation control; orange = LR accuracy on records where the model's own preference is wrong; vertical line = frozen L30. | phase1-step5 | 400 records / 100 pairs | 20260827 (control derangement) | `efafff1c037e` | 6c8e7f3 | 2026-09-17 | agent-unverified; layer curves reported, not selected on |
