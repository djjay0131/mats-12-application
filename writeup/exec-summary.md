...
## Results
J-Lens scoore 0.781 vs 0.519 for a shuffled-label control end of the fact token. But the next token for the same position is 0.800. On the records where the model is wrong, the lens reduces to 0.344 and 0.125, well below chance.  
